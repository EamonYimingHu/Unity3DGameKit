...
namespace Gamekit3D
{
    public class MeleeWeapon : MonoBehaviour
    {
        ...
        protected GameObject Chomper;
        protected GameObject Ellen;
        ...
        //利用游戏demo中已有的攻击系统，结合Wwise和攻击逻辑实现Attack音效
        ...
        public void BeginAttack(bool thowingAttack)
        {
            ...
            //通过判断攻击者类型（主角/怪物/BOSS），触发相应的Ak.SoundEngine.PostEvent
            if (m_Owner.CompareTag("Chomper"))
            {
                AkSoundEngine.PostEvent("Play_SFX_Chomper_Vox_Attack", gameObject);
            }

            else if (m_Owner.CompareTag("Ellen"))

            {
                AkSoundEngine.PostEvent("Play_SFX_Ellen_SwingSound", gameObject);
            };
